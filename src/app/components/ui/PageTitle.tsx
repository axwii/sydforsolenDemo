  ...
  return (
    <div>
      <div className="container mx-auto px-4 pt-8 md:pt-12">
        <svg viewBox="0 0 1000 140" preserveAspectRatio="xMinYMid meet" overflow="visible" className="w-full h-auto max-h-[140px] md:max-h-[210px] overflow-visible" aria-label={title}>
          <text
            x="0"
            y="50%"
